...
% TODO: Re-Write this
The final abstraction involves pointer manipulation and allocating memory. 
Most Vboot data structures contain offsets to other data structures, not full
pointers. 
This makes sense because the data structures are loaded in from disk and they do
not know what addresses they will be loaded in to.
Pointer arithmetic is necessary to find the location of the next data structure.
The following code shows the arithmetic needed
% TODO: Write this
...
In order to assign correct values and have CBMC treat pointers correctly, a
small memory management implementation was needed.
The simplest possible implementation was used.
Memory starts at dress 0x0 and increases as needed. Memory is never reclaimed.
