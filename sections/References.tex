...
E. Chou and S. Malik, "A Secure Bootloader for Demonstrating Formal Verification of Hardware-Firmware Interactions on SoCs"
    ...
    % TODO: More info on TPM specs
    \bibitem{TPM-design}
        ``TPM Main: Part 1 Design Principles'' Trusted Computing Group.\url{https://trustedcomputinggroup.org/wp-content/uploads/Main-Part1-Rev94.pdf}
    \bibitem{TPM-struct}
        ``TPM Main: Part 2 TPM Structures'' Trusted Computing Group.\url{https://trustedcomputinggroup.org/wp-content/uploads/TPM-main-1.2-Rev94-part-2.pdf}
    \bibitem{TPM-cmd}
        ``TPM Main: Part 3 Commands'' Trusted Computing Group.\url{https://trustedcomputinggroup.org/wp-content/uploads/TPM-main-1.2-Rev94-part-3.pdf}
    \bibitem{TCG}
