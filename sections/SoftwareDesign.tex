...
It will also discuss relevant data structures and program flow.
...
verified. 
This section will start at the highest hierarchical level of data structure and then explain the structures that are contained within.

\subsection{Firmware Image}

\begin{figure}
    \centering
    \includegraphics[width=0.6\linewidth]{fw_image.png}
    \caption[Firmware Image Data Layout]{Layout of the Firmware Images~\cite{vboot-data-structures}}
...
\end{subfigure}
\caption[Keyblock Data Structure]{The Keyblock data structure and Metadata for Keys and Signatures}
